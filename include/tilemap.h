bool TILEMAP_LOAD_INTERNAL_USE_ONLY(const char* tileset, int tileSize, int** tiles, unsigned int width, unsigned int height) {
...
typedef struct TileMap2 {
	...
	bool TILEMAP_LOAD_INTERNAL_USE_ONLY();
